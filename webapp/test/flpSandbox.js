		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Second App - Cross App",
									"targetURL": "#comsaplearningsecondapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplearningsecondapp-display": {
								"semanticObject": "comsaplearningsecondapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.learning.secondapp",
									"url": sap.ui.require.toUrl("com/sap/learning/secondapp")
								}
							}
						}
					}
